...
class GUI:
    def __init__(self):
        ...
        # Custom Board
        # self.actual_board = [['grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'ocean'], ['ocean', 'ocean', 'grass', 'grass', 'ocean', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass'], ['grass', 'grass', 'ocean', 'grass', 'grass', 'grass', 'ocean'], ['grass', 'grass', 'grass', 'ocean', 'grass', 'grass', 'grass', 'grass', 'ocean', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'ocean'], ['grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass'], ['grass', 'ocean', 'grass', 'grass', 'grass', 'ocean', 'grass', 'grass'], ['grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass'], ['grass', 'grass', 'grass', 'grass', 'grass', 'ocean', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass'], ['grass', 'grass', 'ocean', 'grass', 'grass', 'grass', 'grass'], ['grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'ocean', 'grass', 'ocean'], ['grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass'], ['grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'ocean', 'grass', 'grass'], ['grass', 'grass', 'ocean', 'grass', 'grass', 'grass', 'ocean', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass']]
        # board = [['grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'ocean'], ['ocean', 'ocean', 'grass', 'grass', 'ocean', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass'], ['grass', 'grass', 'ocean', 'grass', 'grass', 'grass', 'ocean'], ['grass', 'grass', 'grass', 'ocean', 'grass', 'grass', 'grass', 'grass', 'ocean', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'ocean'], ['grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass'], ['grass', 'ocean', 'grass', 'grass', 'grass', 'ocean', 'grass', 'grass'], ['grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass'], ['grass', 'grass', 'grass', 'grass', 'grass', 'ocean', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass'], ['grass', 'grass', 'ocean', 'grass', 'grass', 'grass', 'grass'], ['grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'ocean', 'grass', 'ocean'], ['grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass'], ['grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'ocean', 'grass', 'grass'], ['grass', 'grass', 'ocean', 'grass', 'grass', 'grass', 'ocean', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass', 'grass']]

        self.get_start_point()
        self.get_end_point()
        # Custom Start and End
        # self._start_point = (12, 7)
        # self._end_point = (0, 0)
        # print(f'=====Start Point: ({self._start_point}) | End Point: ({self._end_point})======')
    ...
    def get_end_point(self):
        ...
        while self._start_point == self._end_point or self.actual_board[self._end_point[0]][self._end_point[1]] == 'ocean':
            end_row = random.randint(0, height - 1)
            self._end_point = (end_row, random.randint(0, len(self.grid[end_row]) - 1))
    ...
    def run_game_on_board(self):
        ...
        for pos in lst_path:
            ...
            time.sleep(0.1)  # Adjust the time to control the speed of animation
        ...
        self._screen.blit(txtsurf, (self._screen.get_width() // 2 - txtsurf.get_width() // 2,
                                    self._screen.get_height() - 2 * txtsurf.get_height()))
        pg.display.flip()
        time.sleep(0.5)  # Keep message on screen for 2 seconds
